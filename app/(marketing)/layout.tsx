  ...
  return (
    <div className="min-h-screen flex flex-col text-white selection:bg-red-600/30">
      ...
      <div className="flex flex-grow container mx-auto py-8 px-4 lg:px-0 gap-4"> {/* Adjusted flex container with gap */}
        ...
        {path !== "/about" && path !== "/insignia" && path !== "/careers" && <aside className="w-[30%] p-4 hidden lg:block overflow-y-auto h-[calc(100vh-144px)] sticky top-29"> {/* Leaderboard sidebar with fixed height, independent scrolling, and sticky position */}
          <Leaderboard />
        </aside>}
      </div>  
      <Footer />
